    ...
    createChannel(){
        ...
        .then(data => {
            ...
            ws.onclose = function(closingEvent) {
                console.log(`CXClient:Notification:Web-socket Closed.Channel:${JSON.stringify(channel)}|CloseEvent:${JSON.stringify(closingEvent)}`);
            };
            ws.onerror =function(errorEvent) {
                console.log(`CXClient:Notification:Web-socket Error.Channel:${JSON.stringify(channel)}|ErrorEvent:${JSON.stringify(errorEvent)}`);
            };
        });
    },
